...
public class LighthouseLamp extends AbstractItem {

    private LighthouseLamp(Position3D position) {
        super(position);

        BlockType type = BlockType.LIGHTHOUSE_LAMP;
    ...
    public static LighthouseLamp createForWorld(Position3D position3D) {
        LighthouseLamp item = new LighthouseLamp(position3D);
