...
public class BlockFlipper {
    ...
    static {
        ...
        TYPE_TO_FLIPPED_BLOCK_MAP.put(H_WALL_THICK_B_JOINT, new FlippedBlockType(H_WALL_THICK_T_JOINT, H_WALL_THICK_B_JOINT));
        TYPE_TO_FLIPPED_BLOCK_MAP.put(H_WALL_THICK_T_JOINT, new FlippedBlockType(H_WALL_THICK_B_JOINT, H_WALL_THICK_T_JOINT));
        TYPE_TO_FLIPPED_BLOCK_MAP.put(V_WALL_THICK_L_JOINT, new FlippedBlockType(V_WALL_THICK_L_JOINT, V_WALL_THICK_R_JOINT));
        TYPE_TO_FLIPPED_BLOCK_MAP.put(V_WALL_THICK_R_JOINT, new FlippedBlockType(V_WALL_THICK_R_JOINT, V_WALL_THICK_L_JOINT));
    }
