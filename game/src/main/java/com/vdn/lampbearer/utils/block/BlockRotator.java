...
public class BlockRotator {
    ...
    static {
        ...
        TYPE_TO_ROTATED_BLOCK_MAP.put(H_WALL_THICK_B_JOINT, new RotatedBlockType(V_WALL_THICK_L_JOINT, H_WALL_THICK_T_JOINT, V_WALL_THICK_R_JOINT));
        TYPE_TO_ROTATED_BLOCK_MAP.put(H_WALL_THICK_T_JOINT, new RotatedBlockType(V_WALL_THICK_R_JOINT, H_WALL_THICK_B_JOINT, V_WALL_THICK_L_JOINT));
        TYPE_TO_ROTATED_BLOCK_MAP.put(V_WALL_THICK_L_JOINT, new RotatedBlockType(H_WALL_THICK_T_JOINT, V_WALL_THICK_R_JOINT, H_WALL_THICK_B_JOINT));
        TYPE_TO_ROTATED_BLOCK_MAP.put(V_WALL_THICK_R_JOINT, new RotatedBlockType(H_WALL_THICK_B_JOINT, V_WALL_THICK_L_JOINT, H_WALL_THICK_T_JOINT));
    }
